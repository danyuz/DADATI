...
setwd("C:/Users/Beatriz Garcia/Desktop/DANYU/ECI/ECI_OCT/data") 
dataFiles <- lapply(Sys.glob("OCT*.xlsx"), read_excel)
```
...
```{r}
setwd("C:/Users/Beatriz Garcia/Desktop/DANYU/ECI_OCT/data_modified")
for (i in 1:length(df_final)) {
  write.csv2(df_final[[i]], paste0(i,"OCT.csv"), row.names = FALSE)
}
```
